...
- Join our **Slack workspace** [`r fontawesome::fa(name = "link")`](https://join.slack.com/t/isi-buds/shared_invite/zt-1c3j100is-VaXWhm3jAngm1XGb~ZcAVQ). You may want to download the Slack app because we will be using this for communication throughout the program. Make sure notifications are on.
